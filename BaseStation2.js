class BaseStation2 extends Sensor {
    //SRC: https://www.valvesoftware.com/en/index/base-stations
    //SRC: https://enterprise.vive.com/us/support/vive-pro/category_howto/tips-for-setting-up-the-base-stations.html
    
    constructor(X, Y, DEG, VERSION = 1) {
        const H_FOV = VERSION ? 160 : 150;
        const V_FOV = VERSION ? 115 : 110;
        const RANGE = 7;
        //NOTE: HTC's base station has slightly narrow FOV spec listed
